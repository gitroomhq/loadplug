...
const useFaqList = () => {
  return [
    {
      title: `Can I trust Integrations?`,
      description: `Integrations is proudly open-source! We believe in an ethical and transparent culture, meaning that Integrations will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/gitroomhq/postiz-app" target="_blank" style="text-decoration: underline;">click here</a>.`,
    },
    {
      title: 'What are channels?',
      description: `Integrations allows you to schedule your posts between different channels.
